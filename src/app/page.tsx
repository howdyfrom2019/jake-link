...
export default function Home() {
  return (
    <>
      <main className={"flex min-h-[100dvh] w-full flex-col items-center justify-center bg-gray-100 py-12 dark:bg-gray-900 md:py-24 lg:py-32"}>
          ...
          <div className={"grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3"}>
            <Card>
              <CardContent className={"flex flex-col items-start space-y-2 pt-6"}>
                <div className={"rounded-md bg-gray-900 px-3 py-1 text-sm font-medium text-gray-50"}>
                  Shortened
                </div>
